...
const CommentBox = ({ selectedBlog }) => {
    ...
    useEffect(() => {
        const getAllCommentsOfBlog = async () => {
            try {
                const res = await axios.get(`https://blognest1.onrender.com/comment/${selectedBlog._id}/comment/all`)
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://blognest1.onrender.com/comment/${selectedBlog._id}/create`, { content }, {
                headers: {
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`https://blognest1.onrender.com/comment/${commentId}/delete`, {
                withCredentials: true
            })
            if (res.data.success) {
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const res = await axios.put(
                `https://blognest1.onrender.com/comment/${commentId}/edit`,
     ...
     const likeCommentHandler = async (commentId) => {
         try {
             const res = await axios.get(
                 `https://blognest1.onrender.com/comment/${commentId}/like`,
                 {
                     withCredentials: true,
                 }
             );
